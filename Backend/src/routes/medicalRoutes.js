...
import { createMedical, listMedicals, exportMedicals, getMedical, updateMedical, deleteMedical } from '../controllers/medicalController.js';
...
router.get('/export', roleMiddleware('admin','company_owner','hr','manager','superadmin','super_admin'), exportMedicals);
