...
import { getReport, getAnalyticsSummary, reportEmployees } from '../controllers/reportController.js'
...
router.get('/analytics/summary', requireModule('analytics'), authorize('report.view'), getAnalyticsSummary)
